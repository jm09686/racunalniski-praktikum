...
\begin{table}[!ht]
   ...
   \end{tabular}
\end{table}
% - napis nad tabelo: Dürerjev magični kvadrat 
% - oznaka: table:durer
%   
%    
%    
...
\end{figure}
% Tu vstavite sliko
% - napis nad sliko: Pasijonska fasada, Sagrada Famlia
% - oznaka: fig:sagrada
...
% \begin{definicija}
\begin{definicija}
   Pravimo, da sta dva magična kvadrata \pojem{različna}, če enega ni mogoče dobiti iz drugega s pomočjo zasukov oziroma zrcaljenj.
\end{definicija}
